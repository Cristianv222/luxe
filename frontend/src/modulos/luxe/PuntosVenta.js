...
const PuntosVenta = () => {
        ...
        try {
            ...
            if (data.results) {
                ...
                setPagination({
                    ...
                    totalPages: Math.ceil(data.count / (params.page_size || 20)), // Backend default is usually 20
                    pageSize: 20
                });
            } else {
                setProducts(data || []);
    ...
    const filteredProducts = products; // Products are already filtered by backend via loadData
